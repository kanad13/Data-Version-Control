...
cp -R "$source_folder/data_version_control.ipynb" "$source_folder/.gitignore" "$source_folder/requirements.txt" "$source_folder/assets" "$source_folder/.devcontainer" "$source_folder/readme.md" "$source_folder/back" "$destination_folder/"
